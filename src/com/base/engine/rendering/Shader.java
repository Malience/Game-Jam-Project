	...
	public void updateUniforms(Transform transform, Material material, RenderingEngine renderingEngine)
	{
		...
		for(int i = 0; i < resource.getUniformNames().size(); i++)
		{
			...
			else if(uniformName.startsWith("R_"))
			{
				...
				{
					setUniform(uniformName, (DirectionalLight)renderingEngine.getActiveLight());
				}
				else if(uniformType.equals("PointLight"))
				{
					setUniform(uniformName, (PointLight)renderingEngine.getActiveLight());
				}
				else if(uniformType.equals("SpotLight"))
				{
					setUniform(uniformName, (SpotLight)renderingEngine.getActiveLight());
				}
				else
					renderingEngine.updateUniformStruct(transform, material, renderingEngine, uniformName, uniformType);
			}
...
//				else if(uniformName.equals("depthMVP"))
//				{ 
//					setUniform(uniformName, renderingEngine.getActiveLight().getMVP());
//				}
//				else if(uniformName.equals("depthBiasMVP"))
//				{ 
//					setUniform(uniformName, renderingEngine.getActiveLight().getMVP().mul(new Matrix4f().biasMatrix()));
//				}
				else
	...
	{
		setUniformf(uniformName + ".constant", attenuation.getConstant());
		setUniformf(uniformName + ".linear", attenuation.getLinear());
		setUniformf(uniformName + ".exponent", attenuation.getExponent());
	}
